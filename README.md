...
Однако, если вы используете функцию хранения дневника на Google Диске, Вам следует ознакомиться с политикой приватности Google. По умолчанию записи хранятся только локально в телефоне.  
