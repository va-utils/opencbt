...
class AboutFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val versionTextView : TextView = v.findViewById<TextView>(R.id.versionTextView);
        val sendButton : Button = v.findViewById<Button>(R.id.sendButton);
    ...
    fun sendFeedBack()
    {
        val fbIntent: Intent = Intent(Intent.ACTION_SENDTO);
